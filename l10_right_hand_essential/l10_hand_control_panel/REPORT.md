...
|--------|---------|---------|-----|-------|
| 拇指尖 | 6 | thumb_link5 | 0(弯曲), 1(侧摆), 9(侧旋) | 网格采样 + Jacobian |
| 食指尖 | 11 | index_link4 | 2(弯曲), 6(侧摆) | 网格采样 + Jacobian |
| 中指尖 | 15 | middle_link3 | 3(弯曲) | 采样 + 黄金分割 |
| 无名指尖 | 20 | ring_link4 | 4(弯曲), 7(侧摆) | 网格采样 + Jacobian |
| 小指尖 | 25 | little_link4 | 5(弯曲), 8(侧摆) | 网格采样 + Jacobian |
...
- geom 6 = thumb_link5（指尖网格，在 thumb_link4 body 内）
- geom 11 = index_link4（指尖网格）
- geom 15 = middle_link3（指尖网格）
- geom 20 = ring_link4（指尖网格）
- geom 25 = little_link4（指尖网格）
...
|-----|------|-----------|-----------|-------------|---------------|
| 0 | 拇指弯曲 | 0 | 0.75 | **0.75 (MAX)** | **0 (MIN)** |
| 1 | 拇指侧摆 | 0 | 1.43 | 1.43 | 0 |
| 2 | 食指弯曲 | 0 | 1.62 | 1.62 | 0 |
| 3 | 中指弯曲 | 0 | 1.62 | 1.62 | 0 |
| 4 | 无名指弯曲 | 0 | 1.62 | 1.62 | 0 |
| 5 | 小指弯曲 | 0 | 1.62 | 1.62 | 0 |
| 6 | 食指侧摆 | -0.26 | 0 | 0 | -0.26 |
| 7 | 无名指侧摆 | 0 | 0.13 | **0 (MIN)** | **0.13 (MAX)** |
| 8 | 小指侧摆 | 0 | 0.26 | **0 (MIN)** | **0.26 (MAX)** |
| 9 | 拇指侧旋 | -0.52 | 1.01 | 1.01 | -0.52 |

只有 DOF 7 和 8 是正向的。这意味着 DOF=0（"握拳"）对应大部分关节的最大弯曲角度。
