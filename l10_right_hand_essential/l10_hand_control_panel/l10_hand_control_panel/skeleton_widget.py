...
class HandModelWidget(QWidget):
    ...
    def __init__(self, parent=None):
        ...
        self._cam.distance = 0.45
        self._cam.azimuth = -185
    ...
    def paintEvent(self, event):
        ...
        # 绘制 MuJoCo 渲染图像 (保持宽高比)
        if self._qimage is not None:
            scaled = self._qimage.scaled(self.rect().size(), Qt.KeepAspectRatio, Qt.SmoothTransformation)
    ...
    def _emit_camera_state(self):
        ...
        if self.on_camera_changed:
            ...
            data = [self._cam.distance, normal[0], normal[1], normal[2]]
    ...
    def apply_camera_state(self, camera_data):
        ...
        # 从距离和法向量反推 azimuth/elevation [distance, nx, ny, nz]
        dist = camera_data[0]
