...
BODY_STATIC_QUAT = {
    ...
    3:  np.array([0.4915527, -0.4084116, -0.3433170, -0.6882655]),
...
JOINT_AXES = {
    "thumb_cmc_roll":  np.array([0.9999619232274914, 0.0, -0.008726516783716052]),
    "thumb_cmc_yaw":   np.array([0.0085170149295354, -0.21782038181887997, -0.975951710752621]),
    "thumb_cmc_pitch": np.array([0.0, 1.0, 0.0]),
    "thumb_mcp":       np.array([0.0, 1.0, 0.0]),
    "thumb_ip":        np.array([0.0, 1.0, 0.0]),
    "index_mcp_roll":  np.array([-0.9999619232274914, 0.0, 0.008726516783716052]),
    "index_mcp_pitch": np.array([0.0, 1.0, 0.0]),
    "index_pip":       np.array([0.0, 1.0, 0.0]),
    "index_dip":       np.array([0.0, 1.0, 0.0]),
    "middle_mcp_pitch":np.array([0.0, 1.0, 0.0]),
    "middle_pip":      np.array([0.0, 1.0, 0.0]),
    "middle_dip":      np.array([0.0, 1.0, 0.0]),
    "ring_mcp_roll":   np.array([0.9999619232274914, 0.0, 0.008726516783716052]),
    "ring_mcp_pitch":  np.array([0.0, 1.0, 0.0]),
    "ring_pip":        np.array([0.0, 1.0, 0.0]),
    "ring_dip":        np.array([0.0, 1.0, 0.0]),
    "pinky_mcp_roll":  np.array([0.9999619232274914, 0.0, 0.008726516783716052]),
    "pinky_mcp_pitch": np.array([0.0, 1.0, 0.0]),
    "pinky_pip":       np.array([0.0, 1.0, 0.0]),
    "pinky_dip":       np.array([0.0, 1.0, 0.0]),
}

# body → 关节名
BODY_JOINT_NAMES = {
    1: "thumb_cmc_roll",  2: "thumb_cmc_yaw",  3: "thumb_cmc_pitch",
    4: "thumb_mcp",       5: "thumb_ip",
    6: "index_mcp_roll",  7: "index_mcp_pitch", 8: "index_pip",
    9: "index_dip",
    10: "middle_mcp_pitch", 11: "middle_pip", 12: "middle_dip",
    13: "ring_mcp_roll",  14: "ring_mcp_pitch", 15: "ring_pip",
    16: "ring_dip",
    17: "pinky_mcp_roll", 18: "pinky_mcp_pitch", 19: "pinky_pip",
    20: "pinky_dip",
}

# 关节名 → MuJoCo joint 索引 (与 KINEMATIC_CHAIN 顺序一致)
_JOINT_NAME_TO_IDX = {
    "thumb_cmc_roll": 0, "thumb_cmc_yaw": 1, "thumb_cmc_pitch": 2,
    "thumb_mcp": 3, "thumb_ip": 4,
    "index_mcp_roll": 5, "index_mcp_pitch": 6, "index_pip": 7,
    "index_dip": 8,
    "middle_mcp_pitch": 9, "middle_pip": 10, "middle_dip": 11,
    "ring_mcp_roll": 12, "ring_mcp_pitch": 13, "ring_pip": 14,
    "ring_dip": 15,
    "pinky_mcp_roll": 16, "pinky_mcp_pitch": 17, "pinky_pip": 18,
    "pinky_dip": 19,
}
